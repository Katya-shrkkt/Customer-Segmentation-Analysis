...
There are 2000 customers in database.
...
Average customers age: 48.96 years

### Business Insight

the company's target audience mainly consist of customers around this age.

![result](images/AveragecustomerAge.png?raw=true)
---
...
![result](images/GenderDistribution.png?raw=true)
---
...
![result](images/ProfessionWithTheHighestSpending.png?raw=true)
---

## 5. Average Annual Income

Male average annual income : 110991.32
Female average annual income: 110553.72
...
![result](images/AverageAnnualIncome.png?raw=true)
---
...
## 7. Family Size vs Spending Score
...
![result](images/SpendingScoreFamilySize.png?raw=true)
---

## 8. Top 10 Customers by Spending Score

The highest spending customers were identified.

### Business Insight

These customers may represent a valuable segment for loyalty programs and premium offers.

![result](images/Top10BySpendingScore.png?raw=true)
---

## 9. Top 10 Customers by Annual Income

The highest-income customers were identified.

### Business Insight

High-income customers may be suitable targets for premium products or services.

![result](images/Top10ByAnnualIncome.png?raw=true)
---

# Overall Conclusion

The project demonstrates how SQL can be used to answer business questions using customer data.

The analysis provides insights into customer demographics, income levels, professions, and spending behavior, helping businesses better understand their customers.
